...
//--------------------------------------------------------------
// name: Renderer()
// desc: determines how to render the nodes and edges in arbor
//--------------------------------------------------------------
    ...
    var that = {
      ...
      redraw:function(){
        ...
        sys.eachEdge(function(edge, p1, p2){
		  ...
		  console.log(edge);
          gfx.line(p1, p2, {stroke:"#b2b19d", width:1, alpha:edge.target.data.alpha})
		  gfx.text(edge.data.weight, p1.x + ((p2.x - p1.x) * 0.5), p1.y + ((p2.y - p1.y) * 0.5), {color:"black", align:"center", font:"Arial", size:12})
		  
        })
		sys.eachNode(function(node, pt){
			console.log(node);
          var w = Math.max(20, 20+gfx.textWidth(node.name) )
		  gfx.oval(pt.x-w/2, pt.y-w/2, w, w, {fill:"red", alpha:1})
